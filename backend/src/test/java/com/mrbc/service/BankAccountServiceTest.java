...
public class BankAccountServiceTest {
  ...
  @Mock private BankUserRepository bankUserRepository;

  @InjectMocks private BankAccountService bankAccountService;

  @InjectMocks private BankUserService bankUserService;
  ...
  void deposit_shouldIncreaseBalance_whenAccountExists() {
    ...
    BankAccount createdAccount =
        bankAccountService.createAccountForUser(createdUser.getId(), account);
  ...
  void transfer_shouldMoveFundsBetweenAccounts_whenSufficientFunds() {
    ...
    BankAccount createdFromAccount =
        bankAccountService.createAccountForUser(createdFromUser.getId(), fromAccount);

    BankUser createdToUser = bankUserService.createUser(toBankUser);
    BankAccount createdToAccount =
        bankAccountService.createAccountForUser(createdToUser.getId(), toAccount);

    // Transfer action
    BankAccount resultFrom =
        bankAccountService.withdraw(createdFromAccount.getId(), transferAmount);
